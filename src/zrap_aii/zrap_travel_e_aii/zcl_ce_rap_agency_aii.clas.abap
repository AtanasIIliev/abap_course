CLASS zcl_ce_rap_agency_aii DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zz_travel_agency_es5_aii-agencyid.
    TYPES t_business_data TYPE TABLE OF zz_travel_agency_es5_aii.
...
CLASS ZCL_CE_RAP_AGENCY_AII IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_AII' ).
